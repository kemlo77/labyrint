...
describe('HexagonalGrid', () => {
    ...
    it('verifying neighbour count', () => {
        ...
        expect(rectGrid.grid[0].map(cell => cell.neighbours.length)).to.deep.equal([2,5,3,5,2]);
        ...
        expect(rectGrid.grid[4].map(cell => cell.neighbours.length)).to.deep.equal([3,3,5,3,3]);
    });
